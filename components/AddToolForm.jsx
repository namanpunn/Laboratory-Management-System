...
export default function AddToolForm({ onSuccess }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-6 border rounded-lg shadow-sm bg-white w-full max-w-md sm:max-w-full mx-auto sm:mx-0">
  <div className="mb-5">
  ...
  <div className="mb-5">
    ...
    <div className="flex rounded-md w-full">
      ...
      <input
        ...
        className="flex-1 p-2.5 text-center border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-12"
      />
      <button
        type="button"
  ...
  <div className="flex justify-end">
    <button
      type="submit"
      disabled={isLoading}
      className="w-full sm:w-auto inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
    >
      {isLoading ? (
        <>
